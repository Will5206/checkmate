...
import controllers.ReceiptParsingController;
import controllers.ReceiptCRUDController;
import controllers.ReceiptListController;
import controllers.ReceiptItemController;
import controllers.ReceiptParticipantController;
import controllers.ReceiptPaymentController;
...
public class Server {
    ...
    public static void main(String[] args) {
        try {
            ...
            server.createContext("/api/receipt/parse", new ReceiptParsingController.ParseReceiptHandler());
            server.createContext("/api/receipts/create", new ReceiptCRUDController.CreateReceiptHandler());
            server.createContext("/api/receipts/view", new ReceiptCRUDController.ViewReceiptHandler());
            server.createContext("/api/receipts/pending", new ReceiptListController.ListPendingReceiptsHandler());
            server.createContext("/api/receipts/activity", new ReceiptListController.GetActivityReceiptsHandler());
            server.createContext("/api/receipts/accept", new ReceiptParticipantController.AcceptReceiptHandler());
            server.createContext("/api/receipts/decline", new ReceiptParticipantController.DeclineReceiptHandler());
            server.createContext("/api/receipts/items/claim", new ReceiptItemController.ClaimItemHandler());
            server.createContext("/api/receipts/items/assignments", new ReceiptItemController.GetItemAssignmentsHandler());
            server.createContext("/api/receipts/pay", new ReceiptPaymentController.PayReceiptHandler());
            server.createContext("/api/receipts/add-participants", new ReceiptParticipantController.AddParticipantsHandler());
