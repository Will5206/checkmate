...
if [ $? -eq 0 ]; then
    echo ""
    echo "✓ Successfully cleared all receipt and transaction data!"
    echo "User accounts, sessions, and friendships have been preserved."
    echo "Receipt and transaction tables are now empty and AUTO_INCREMENT counters have been reset."
else
    echo ""
