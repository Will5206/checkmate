...
# Script to run the complete column migration (non-interactive version)
...
# Run the migration (no confirmation needed)
...
if [ $? -eq 0 ]; then
    ...
    echo "Existing receipts have been set to complete = FALSE."
    echo ""
